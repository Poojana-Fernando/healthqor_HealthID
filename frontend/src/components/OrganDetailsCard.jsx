...
export default function OrganDetailsCard({ activeRegion = null, onClear, profile = null }) {
  ...
  if (!isOrganSelected) {
    return (
      <div className="premium-glass rounded-3xl p-8 md:p-10 shadow-glass-glow-lg flex flex-col justify-between h-[680px] max-h-[680px] overflow-hidden">
        ...
        <div className="mt-8 text-center border-t border-white/10 pt-4 shrink-0 font-mono text-[9px] text-accent2/40 tracking-widest uppercase">
  ...
  return (
    <div 
      className="premium-glass rounded-3xl p-8 md:p-10 shadow-glass-glow-lg flex flex-col justify-between h-[680px] max-h-[680px] overflow-hidden transition-all duration-355"
      style={{
        boxShadow: `0 8px 32px rgba(0, 0, 0, 0.25), 0 0 30px ${organProfile.color}15`,
        borderColor: `${organProfile.color}40`
      }}
    >
      <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
      ...
      <div className="mt-8 pt-4 border-t border-white/10 flex justify-between items-center text-[10px] font-mono text-white/40 shrink-0">
        ...
        <span style={{ color: organProfile.color }} className="animate-pulse font-bold">
          TARGET MONITORED
        </span>
      </div>
    </div>
